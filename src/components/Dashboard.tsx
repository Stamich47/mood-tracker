...
export default function Dashboard({ initialLogs }: { initialLogs: Log[] }) {
  ...
  return (
    <div className="h-dvh bg-zinc-50 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 font-sans overflow-hidden flex flex-col">
      <main className="w-full pt-6 lg:pt-24 pb-24 lg:pb-6 flex-col gap-4 lg:gap-6 flex-1 overflow-y-auto">
        <div className="max-w-3xl mx-auto w-full px-4 lg:px-6 flex flex-col gap-4 lg:gap-6">
          {/* Mobile Header */}
          <header className="shrink-0 lg:hidden mb-4">
